...
export default function CTA() {
    return (
        <section className="py-32 bg-gray-50 dark:bg-black relative overflow-hidden flex items-center justify-center transition-colors duration-300">
            {/* Background Gradient */}
            <div className="absolute inset-0 bg-gradient-to-r from-yellow-600/10 via-gray-50 dark:via-black to-gray-50 dark:to-black z-0" />
            <div className="absolute right-0 top-0 w-1/2 h-full bg-gradient-to-l from-primary/5 dark:from-primary/10 to-transparent blur-3xl" />
            ...
            <div className="container mx-auto px-6 relative z-10 text-center">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-6">
                    ...
                    <button className="text-gray-900 dark:text-white border border-gray-300 dark:border-white/20 hover:border-primary dark:hover:border-white px-10 py-5 rounded-full font-bold text-xl transition-colors flex items-center gap-3">
